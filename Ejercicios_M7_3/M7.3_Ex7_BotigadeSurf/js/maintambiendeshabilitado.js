function main() {
  ...
  //     "4. Salir"
  // );
  let seleccion = -1; //aixo fa ometre el primer prompt
...
function calcularMaterial() {
  ...
  // if (experiencia)
  //   //si poses nomes experiencia equival a true, si negas experiencoia !experiencia equivaldria a false!!!
  //   alert("Puedes alquilar Tabla de fibra");
  // else alert("Deberás alquilar Tabla de espuma");
  // experiencia
  //   ? alert("Puedes alquilar Tabla de fibra")
  //   : alert("Deberás alquilar Tabla de espuma");
  alert(
    experiencia
